  ...
  return (
    <div className="small-footer">
        ...
        <div class="container px-5 py-5 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <span class="ml-3 text-xl">EASY CINE TV</span>
            </a>
            <p class="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">© 2023 Easy Cine TV—
